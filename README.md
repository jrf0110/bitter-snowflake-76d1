...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/bitter-snowflake-76d1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-snowflake-76d1
```

A live public deployment of this template is available at [https://bitter-snowflake-76d1.templates.workers.dev](https://bitter-snowflake-76d1.templates.workers.dev)
